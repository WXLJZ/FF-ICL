...
class Ex_Retriver():
    def __init__(self, ex_file, paths=None, encode_method='KATE'):
        ...
        if encode_method == 'KATE':
            ...
            self.tokenized_sents = [sent.split() for sent in self.sents]
    ...
    def search_examples(self, query, selected_k, verbose=True):
        ...
        if self.encode_method == 'random':
            ...
            #                 'You got it right!' in self.data_dict[self.sents[idx]][2]:
            ...
            #                 'You got it wrong!' in self.data_dict[self.sents[idx]][2]:
            #             choosed_idxs[idx] = dist
            #             n_dims[i] -= 1
            #             wrong_n[i] -= 1
            #             if verbose:
